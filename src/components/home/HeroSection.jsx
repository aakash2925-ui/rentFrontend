...
export default function HeroSection() {
  return (
    <section className="relative isolate flex min-h-[400px] overflow-hidden bg-mist dark:bg-[#11071f]">
      <div className="absolute inset-0 -z-10 bg-gradient-to-br from-white via-lavender/70 to-violet-100 dark:from-[#11071f] dark:via-violet-950 dark:to-[#1b0b32]">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_18%,rgba(139,92,246,0.24),transparent_34%),radial-gradient(circle_at_78%_35%,rgba(217,70,239,0.18),transparent_32%),linear-gradient(135deg,rgba(255,255,255,0.88),rgba(245,239,255,0.55),rgba(255,255,255,0.75))] dark:bg-[radial-gradient(circle_at_20%_18%,rgba(139,92,246,0.28),transparent_34%),radial-gradient(circle_at_78%_35%,rgba(217,70,239,0.20),transparent_32%),linear-gradient(135deg,rgba(17,7,31,0.96),rgba(45,16,86,0.74),rgba(17,7,31,0.94))]" />
